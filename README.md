...
The goal is a better and better prediction of the result of sampling (taking a particular action) of any state. Seek specific samples, respond to unexpected samples from the use of imperfect rules, and combine similar samples to encompass a span of untested states.
