...
Based on an improved interpretation of the Karnaugh Map, and introspection.  Karnaugh Maps have a bug, encompasing a large number of bits, but there is a work-around, see the top of the file theory.html and max_kmap.jpg.
