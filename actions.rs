...
pub fn dom0_act5(cur: &SomeState) -> SomeState {
    let new_state = cur.xor_bit_number(5);
    println!(
        "\nDom 0 Act 5 {} -> {} R[{}]",
        cur,
        new_state,
...
pub fn dom0_act6(cur: &SomeState) -> SomeState {
    let new_state = cur.xor_bit_number(2).xor_bit_number(3);
    println!(
        "\nDom 0 Act 6 {} -> {} R[{}]",
        cur,
        new_state,
...
pub fn dom0_act7(cur: &SomeState) -> SomeState {
    let new_state = cur.xor_bit_number(6).xor_bit_number(7);
    println!(
        "\nDom 0 Act 7 {} -> {} R[{}]",
        cur,
        new_state,
...
pub fn dom0_act8(cur: &SomeState) -> SomeState {
    let new_state = cur.xor_bit_number(6);
    println!(
        "\nDom 0 Act 8 {} -> {} R[{}]",
        cur,
        new_state,
...
pub fn dom1_act2(cur: &SomeState) -> SomeState {
    let new_state = cur.xor_bit_number(7);
    println!(
        "\nDom 1 Act 2 {} -> {} R[{}]",
        cur,
        new_state,
...
pub fn dom1_act3(cur: &SomeState) -> SomeState {
    let new_state = cur.xor_bit_number(8);
    println!(
        "\nDom 1 Act 3 {} -> {} R[{}]",
        cur,
        new_state,
...
pub fn dom1_act4(cur: &SomeState) -> SomeState {
    let new_state = cur.xor_bit_number(9);
    println!(
        "\nDom 1 Act 4 {} -> {} R[{}]",
        cur,
        new_state,
...
pub fn dom1_act5(cur: &SomeState) -> SomeState {
    let new_state = cur.xor_bit_number(10);
    println!(
        "\nDom 1 Act 5 {} -> {} R[{}]",
        cur,
        new_state,
...
pub fn dom1_act6(cur: &SomeState) -> SomeState {
    let new_state = if cur.is_bit_set(5) {
        cur.xor_bit_number(8)
    } else if cur.is_bit_set(6) {
        cur.xor_bit_number(9)
    } else {
        cur.xor_bit_number(10)
    };
    println!(
        "\nDom 1 Act 6 {} -> {} R[{}]",
        cur,
