...
pub fn action0(cur: &SomeState, num_seen: usize) -> SomeState {
    let num = 0;
...
pub fn action1(cur: &SomeState, _num_seen: usize) -> SomeState {
    let num = 1;
...
pub fn action2(cur: &SomeState, _num_seen: usize) -> SomeState {
    let num = 2;
    let new_state = cur.toggle_bits(&[num]);
    println!("\nAct {}  {} -> {}", num, cur, new_state);
    return new_state;
...
pub fn action3(cur: &SomeState, _num_seen: usize) -> SomeState {
    let num = 3;
    let new_state = cur.toggle_bits(&[num]);
    println!("\nAct {}  {} -> {}", num, cur, new_state);
    return new_state;
