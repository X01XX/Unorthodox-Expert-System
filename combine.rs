...
mod tests {
    ...
    fn can_combine_check_between_ref1() -> Result<(), String> {
        ...
        let mut sqr1 = SomeSquare::new(SomeState::new_from_string(1, "s1111").unwrap(), SomeState::new_from_string(1, "s1111").unwrap());
        ...
        let mut sqr2 = SomeSquare::new(SomeState::new_from_string(1, "s0000").unwrap(), SomeState::new_from_string(1, "s0000").unwrap());
        ...
        let sqr3 = SomeSquare::new(SomeState::new_from_string(1, "s0001").unwrap(), SomeState::new_from_string(1, "s0001").unwrap());
        squares.insert(sqr3, 0, 0);

        let sqr1: &SomeSquare = squares.find(&SomeState::new_from_string(1, "s1111").unwrap()).unwrap();
        let sqr2: &SomeSquare = squares.find(&SomeState::new_from_string(1, "s0000").unwrap()).unwrap();
        ...
        let mut sqr4 = SomeSquare::new(SomeState::new_from_string(1, "s0011").unwrap(), SomeState::new_from_string(1, "s0011").unwrap());
    ...
    fn can_combine_check_between_ref2() -> Result<(), String> {
        ...
        let mut sqr2 = SomeSquare::new(SomeState::new_from_string(1, "s0001").unwrap(), SomeState::new_from_string(1, "s0001").unwrap());
        ...
        let mut sqr3 = SomeSquare::new(SomeState::new_from_string(1, "s0011").unwrap(), SomeState::new_from_string(1, "s0011").unwrap());
        sqr3.add_result(SomeState::new_from_string(1, "s0011").unwrap());
        squares.insert(sqr3, 0, 0);

        let sqr1: &SomeSquare = squares.find(&SomeState::new_from_string(1, "s1111").unwrap()).unwrap();
        let sqr2: &SomeSquare = squares.find(&SomeState::new_from_string(1, "s0001").unwrap()).unwrap();
    ...
    fn can_combine_check_between_ref3() -> Result<(), String> {
        ...
        let mut sqr3 = SomeSquare::new(SomeState::new_from_string(1, "s0001").unwrap(), SomeState::new_from_string(1, "s0001").unwrap());
    ...
    fn can_combine_check_between_ref4() -> Result<(), String> {
        ...
        let sqr3 = SomeSquare::new(SomeState::new_from_string(1, "s0001").unwrap(), SomeState::new_from_string(1, "s0000").unwrap());
        squares.insert(sqr3, 0, 0);
    ...
    fn can_combine_check_between_ref5() -> Result<(), String> {
        ...
        let sqr1 = SomeSquare::new(SomeState::new_from_string(1, "s1111").unwrap(), SomeState::new_from_string(1, "s1111").unwrap());
        squares.insert(sqr1, 0, 0);

        let sqr2 = SomeSquare::new(SomeState::new_from_string(1, "s0000").unwrap(), SomeState::new_from_string(1, "s0000").unwrap());
        squares.insert(sqr2, 0, 0);

        let sqrx: &SomeSquare = squares.find(&SomeState::new_from_string(1, "s1111").unwrap()).unwrap();
        let sqry: &SomeSquare = squares.find(&SomeState::new_from_string(1, "s0000").unwrap()).unwrap();
    ...
    fn can_combine_ref1() -> Result<(), String> {
        ...
        let sqr1 = SomeSquare::new(SomeState::new_from_string(1, "s0000").unwrap(), SomeState::new_from_string(1, "s0000").unwrap());

        // Create second Pn::One square
        let sqr2 = SomeSquare::new(SomeState::new_from_string(1, "s1111").unwrap(), SomeState::new_from_string(1, "s1111").unwrap());

        // Create a Pn::One group
        let grp1 = SomeGroup::new(SomeRegion::new(&sqr1.state, &sqr2.state), sqr1.rules.union(&sqr2.rules).unwrap(), true);
    ...
    fn can_combine_ref2() -> Result<(), String> {
        ...
        let sqr1 = SomeSquare::new(SomeState::new_from_string(1, "s0011").unwrap(), SomeState::new_from_string(1, "s0011").unwrap());
        let sqr2 = SomeSquare::new(SomeState::new_from_string(1, "s1001").unwrap(), SomeState::new_from_string(1, "s1001").unwrap());
    ...
    fn can_combine_ref3() -> Result<(), String> {
        ...
        let sqr1 = SomeSquare::new(SomeState::new_from_string(1, "s0011").unwrap(), SomeState::new_from_string(1, "s0011").unwrap());
        let mut sqr2 = SomeSquare::new(SomeState::new_from_string(1, "s1001").unwrap(), SomeState::new_from_string(1, "s1000").unwrap());
    ...
    fn can_combine_ref4() -> Result<(), String> {
        ...
        let mut sqr1 = SomeSquare::new(SomeState::new_from_string(1, "s0011").unwrap(), SomeState::new_from_string(1, "s0011").unwrap());
        ...
        let mut sqr4 = SomeSquare::new(SomeState::new_from_string(1, "s0111").unwrap(), SomeState::new_from_string(1, "s0011").unwrap());
        ...
        // Create second Pn::One square
        let mut sqr5 = SomeSquare::new(SomeState::new_from_string(1, "s1000").unwrap(), SomeState::new_from_string(1, "s1000").unwrap());
        ...
        let mut sqr6 = SomeSquare::new(SomeState::new_from_string(1, "s1011").unwrap(), SomeState::new_from_string(1, "s1001").unwrap());
    ...
    fn can_combine_ref5() -> Result<(), String> {
        ...
        // Create Pn::One pnc square.
        let mut sqr3 = SomeSquare::new(SomeState::new_from_string(1, "s1001").unwrap(), SomeState::new_from_string(1, "s1001").unwrap());
        sqr3.add_result(SomeState::new_from_string(1, "s1001").unwrap());

        // Create Pn::Two, non-pnc square.
        let mut sqr4 = SomeSquare::new(SomeState::new_from_string(1, "s1011").unwrap(), SomeState::new_from_string(1, "s1011").unwrap());
        sqr4.add_result(SomeState::new_from_string(1, "s1010").unwrap());
        ...
        // Create Pn::Two, pnc, square
        let mut sqr5 = SomeSquare::new(SomeState::new_from_string(1, "s0011").unwrap(), SomeState::new_from_string(1, "s0011").unwrap());
        sqr5.add_result(SomeState::new_from_string(1, "s0010").unwrap());
        sqr5.add_result(SomeState::new_from_string(1, "s0011").unwrap());
        sqr5.add_result(SomeState::new_from_string(1, "s0010").unwrap());
    
        // Create Pn::One non-pnc square.
        let sqr6 = SomeSquare::new(SomeState::new_from_string(1, "s1111").unwrap(), SomeState::new_from_string(1, "s1111").unwrap());
    ...
    fn can_combine_subset_ref1() -> Result<(), String> {
        ...
        // Create Pn::Unpredictable square
        let mut sqr1 = SomeSquare::new(SomeState::new_from_string(1, "s0000").unwrap(), SomeState::new_from_string(1, "s0000").unwrap());
        sqr1.add_result(SomeState::new_from_string(1, "s0001").unwrap());
        sqr1.add_result(SomeState::new_from_string(1, "s0010").unwrap());

        // Create second Pn::Unpredictable square
        let mut sqr2 = SomeSquare::new(SomeState::new_from_string(1, "s1111").unwrap(), SomeState::new_from_string(1, "s1111").unwrap());
        ...
        let grp1 = SomeGroup::new(SomeRegion::new(&sqr1.state, &sqr2.state), RuleStore::new(), true);

        // Create Pn::One square
        let mut sqr3 = SomeSquare::new(SomeState::new_from_string(1, "s0010").unwrap(), SomeState::new_from_string(1, "s0011").unwrap());
    ...
    fn can_combine_subset_ref2() -> Result<(), String> {
        ...
        let mut sqr3 = SomeSquare::new(SomeState::new_from_string(1, "s0000").unwrap(), SomeState::new_from_string(1, "s0000").unwrap());
    ...
    fn can_combine_subset_ref3() -> Result<(), String> {
        ...
        // Create second Pn::Two square
        let mut sqr2 = SomeSquare::new(SomeState::new_from_string(1, "s1110").unwrap(), SomeState::new_from_string(1, "s1110").unwrap());
    ...
    fn can_combine_subset_ref4() -> Result<(), String> {
        ...
        // Create Pn::One square
        let sqr4 = SomeSquare::new(SomeState::new_from_string(1, "s0010").unwrap(), SomeState::new_from_string(1, "s1111").unwrap());
