...
mod tests {
    ...
    fn cycle_through_pn_pnc_values() -> Result<(), String> {
        let mut sqrx = SomeSquare::new(&SomeSample::from_str("s0101->s0101")?);
        assert_eq!(sqrx.pn, Pn::One);
        assert!(!sqrx.pnc);

        // Second result, same as the first.
        let changed = sqrx.add_sample(&SomeSample::from_str("s0101->s0101")?);
        assert!(!changed);
        ...
        let changed = sqrx.add_sample(&SomeSample::from_str("s0101->s0100")?);
        assert!(changed);
    ...
    fn compatible_pn_1_1() -> Result<(), String> {
        ...
        // Create square 5.
        let sqr_5 = SomeSquare::new(&SomeSample::from_str("s0101->s0101")?);
        println!("sqr_5: {sqr_5}");

        // Create square d, compatible to square 5.
        let sqr_d = SomeSquare::new(&SomeSample::from_str("s1101->s1101")?);
        println!("sqr_d: {sqr_d}");
        ...
        let sqr_d = SomeSquare::new(&SomeSample::from_str("s1101->s1001")?);
        println!("sqr_d: {sqr_d}");
    ...
    fn compatible_pn_2_2() -> Result<(), String> {
        // Create sqr_d pn 2.
        let mut sqr_d = SomeSquare::new(&SomeSample::from_str("s1101->s1101")?);

        sqr_d.add_sample(&SomeSample::from_str("s1101->s1100")?);
        println!("sqr_d {sqr_d}");

        // Create sqr_5 pn 2.
        let mut sqr_5 = SomeSquare::new(&SomeSample::from_str("s0101->s0101")?);

        sqr_5.add_sample(&SomeSample::from_str("s0101->s0100")?);
        println!("sqr_5 {sqr_5}");
        ...
        let mut sqr_5 = SomeSquare::new(&SomeSample::from_str("s0101->s0100")?);

        sqr_5.add_sample(&SomeSample::from_str("s0101->s0101")?);
        println!("sqr_5 {sqr_5}");
        ...
        let mut sqr_5 = SomeSquare::new(&SomeSample::from_str("s0101->s0110")?);
    ...
    fn compatible_only_one_pn_u() -> Result<(), String> {
        ...
        sqr_d.add_sample(&SomeSample::from_str("s1101->s1000")?);
    ...
    fn compatible_pn_u_u() -> Result<(), String> {
        ...
        let mut sqr_1 = SomeSquare::new(&SomeSample::from_str("s0001->s0001")?);

        sqr_1.add_sample(&SomeSample::from_str("s0001->s0010")?);

        sqr_1.add_sample(&SomeSample::from_str("s0001->s0100")?);
        println!("sqr_1 {sqr_1}");
    ...
    fn compatible_pn_2_1() -> Result<(), String> {
        ...
        let sqr_1 = SomeSquare::new(&SomeSample::from_str("s0001->s0011")?);
        ...
        sqr_1.add_sample(&SomeSample::from_str("s0001->s0001")?);
        sqr_1.add_sample(&SomeSample::from_str("s0001->s0001")?);
        println!("sqr_1 {sqr_1}");
